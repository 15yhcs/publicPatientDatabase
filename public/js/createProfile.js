...
function visibilityT() { 
	    var x = document.getElementById("tStatus").value;
	    if(x === "No"){
	        document.getElementById("TerminationCause").style.visibility = "hidden";
	    }
	    else{
	        document.getElementById("TerminationCause").style.visibility = "visible";
	    }
	}
